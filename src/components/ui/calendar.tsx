...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex flex-col sm:flex-row text-slate-12 dark:text-slatedark-12 space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        head_row: "flex",
        head_cell:
          "text-slate-7 rounded-md w-9 font-normal text-[0.8rem] dark:text-slatedark-7",
        ...
        day_selected:
          "bg-green-8 text-slate-12 hover:bg-green-6 focus:bg-green-6 dark:hover:bg-greendark-6 dark:focus:bg-greendark-6 dark:text-slatedark-12 dark:bg-greendark-8",
        day_today:
          "bg-slate-7 text-slate-12 dark:bg-slatedark-7 text-slatedark-12",
        day_outside:
